...
1. The purpose of this project is to start performing numeric data analysis using Python and the numpy module, using real world data.

2. This program takes in the dataset provided via Kaggle and processes it.

3. The expected output for this assignment is
   A. The field goal accuracy, three point accuracy, and free throw accuracy for each player in each season.
   B. The average points scored per minute for each player in each season.
   C. The overall shooting accuracy of each player in each season.
